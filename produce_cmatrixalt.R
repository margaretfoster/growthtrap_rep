## copy of STM's produce_cmatrix script
## to break apart their plot.estimatedeffect so that I can
##aggregate estimated effects across multiple topics

## from https://github.com/bstewart/stm/blob/master/R/produce_cmatrix.R
...
produce_cmatrixalt <- function(prep, covariate, method,cov.value1=NULL,
