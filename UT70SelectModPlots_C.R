...
pdf("topicProportions_UT70EDModel.pdf")
plot.STM(selected18,
         type="summary",
...
pdf("dayModel_UT70_cluster1.pdf")
...
pdf("dayModel_UT70_cluster2.pdf")
...
pdf("dayModel_UT70_cluster3.pdf")
plot.STM(selected18,
         type="labels",
         labeltype="frex",                  
         # n=10,
...
pdf("dayModel_UT70_cluster4.pdf")
...
## Fig A4_left:
pdf("HouthiandLT_UT7_K18_top.pdf",width=8, height=4)
plot(selected18,
     type="labels",
     labeltype="frex",
...
pdf("HouthiandLT_UT7_K18_bottom.pdf",width=8, height=4)
...
## Fig A4_right
pdf("AASAndMiscYemen_UT7_K18_top.pdf",width=8, height=4)
plot(selected18,
     type="labels",
     labeltype="frex",
     text.cex = 1,
...
pdf("AASAndMiscYemen_UT7_K18_bottom.pdf",width=8, height=4)
plot.estimateEffect(allTopics18,
                    "elapsedDaysAll",
                    xlab="Time (2004-2016)",
                    xaxt="n",
...
##
## Fig A5 left
pdf("ClashFactions_UT7_K18_top.pdf",width=8, height=4)
plot(selected18,
     type="labels",
     labeltype="frex",
...
pdf("ClashFactions_UT7_K18_bottom.pdf",width=8, height=4)
plot.estimateEffect(allTopics18,
                    "elapsedDaysAll",
                    xlab="Time (2004-2016)",
                    xaxt="n",
...
pdf("TransJihadiAlt_UT7_K18_top.pdf",width=8, height=4)
plot(selected18,
     type="labels",
     labeltype="frex",
...
pdf("TransJihadiAlt_UT7_K18_bottom.pdf",width=8, height=4)
plot.estimateEffect(allTopics18,
                    "elapsedDaysAll",
                    xlab="Time (2004-2016)",
                    xaxt="n",
